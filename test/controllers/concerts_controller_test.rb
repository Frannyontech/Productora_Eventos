...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post concerts_url, params: { concert: { date_event: @concert.date_event, group_id: @concert.group_id, location: @concert.location } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { date_event: @concert.date_event, group_id: @concert.group_id, location: @concert.location } }
